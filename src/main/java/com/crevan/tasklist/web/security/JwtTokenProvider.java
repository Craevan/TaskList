...
import com.crevan.tasklist.domain.exception.AccessDeniedException;
...
import com.crevan.tasklist.service.props.JwtProperties;
...
public class JwtTokenProvider {
    ...
    public String createRefreshToken(final Long userId, String username) {
        Claims claims = Jwts.claims().setSubject(username);
        claims.put("id", userId);
        Date now = new Date();
